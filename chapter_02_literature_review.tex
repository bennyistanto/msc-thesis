...
approximately 14~hours after real time and is the variant
operated on in this study;
...
deviation ratio toward unity has no corresponding effect on the
day-by-day pairing: the correction introduces no rank reversals, so
the Pearson correlation is left close to its raw value. This is not a deficiency
...
for the east. The convective peak therefore sits well inside a
single UTC day and is not split by the UTC boundary.

The effect
is one of labelling rather than of splitting: in the western zone

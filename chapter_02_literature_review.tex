...
%
% Source material:
%   - paper/draft_literature_review.docx           (existing draft, citation backbone)
%   - paper/additional_information.md              (technical Q&A entries)
%   - paper/PPS1691_..._compact_20260526.tex       (compact seminar refs)
%   - paper/PPS1591_..._mdpi.docx                  (parallel MDPI manuscript)
%
% Conventions (per DECISIONS.md):
%   - No em-dashes; no AI-language watchlist; no overclaim
%   - Long-form abbreviation on first use, short form after
%   - Citation keys descriptive: \cite{ref:author2024}
% ============================================================
...
Nusa Tenggara~\citep{ref:tan2016, ref:ramadhan2022}. The
...
IMERG V07~\citep{ref:huffman2020} merges three input streams.
...
1983 onward with no gauge integration. The Multi-Source Weighted-Ensemble
Precipitation (MSWEP) \citep{ref:beck2017}
...
PERSIANN-CDR            & 3--5 days  & 1983 -- present & No gauge integration            & 0.25$^{\circ}$ \\
...
precipitation~\citep{ref:maggioni2016, ref:tang2020}. Over the
...
only at dekadal or longer aggregation~\cite{ref:tang2020,
ref:tan2016}. These bias modes motivate the methodological
...
quantitative precipitation forecasts and remotely-sensed
products~\citep{ref:wmo1485, ref:wmo1317}. The framework allows
...
(typically 1, 5, 10, 20, 50, 100, and 150~mm/day), exposing the
threshold-dependence directly. The framework adopted in this
study uses the seven WMO thresholds and reports separate
categorical metrics at each.
...
sites~\citep{ref:wmo1485}. Gridded gauge analyses such as the
...
stable GPD fits. Parameter estimation by L-moments
\citep{ref:hoskingwallis1997} is preferred over maximum
likelihood for the small exceedance samples typical of
per-pixel per-dekad fits, because L-moments are less sensitive
to outliers and converge well in the 30 to 100 exceedance
range. Stage~3 of the LSEQM+DL pipeline implements this hybrid
strategy with a fixed 80th-percentile threshold and a
five-fold cross-validation aggregation to reduce variance on
the GPD parameter estimates.
...
satellite precipitation correction in several recent
studies~\citep{ref:pan2019, ref:banomedina2020}. The principle
...
against gauge networks and reanalyses over tropical regions
...
\citep{ref:ramadhan2022}. These values define the empirical
...
and Earth observation \cite{ref:perkel2018, ref:beg2021,
ref:wagemann2022}. A notebook integrates code, results, and
...
self-documenting workflows \citep{ref:beg2021, ref:kluyver2016},
and to teach climate-data analytics in a way that makes the
underlying processing steps explicit and modifiable
\citep{ref:wagemann2022, ref:liu2023}. The notebook format
...
without local installation \cite{ref:kamelboulos2023,
ref:gorelick2017, ref:wu2020}. Google Colab itself
...
ref:granger2021}. Second, the notebooks can be opened in either
...
\citep{ref:ramadhan2022}. Two monsoon phases set the seasonal
...
land \citep{ref:ramadhan2022}. Indonesia spans three standard

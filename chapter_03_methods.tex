...
% occupy the page height as its width (same approach as Figs 3.2/3.3). The PNG
% is the original landscape map; LaTeX handles the rotation.
\begin{figure}[p]
\centering
\rotatebox{90}{%
  \includegraphics[width=\figThreeOneWidth\textheight]{fig_thesis_03_coverage.png}%
}
\caption[Study-area data coverage over Indonesia]{Study-area data coverage over Indonesia: the IMERG-L $0.1^{\circ}$ land footprint ($19{,}395$ pixels), the CPC-UNI $0.5^{\circ}$ native calibration grid, and the $180$ archived BMKG stations by region.\label{fig:coverage}}
\end{figure}

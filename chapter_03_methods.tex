...
for cloud-based reproducibility checks. The thesis was typeset in
LaTeX using the MiKTeX distribution, with Times New Roman as the body
font in accordance with the IPB scientific-writing guidelines (Pedoman
Penulisan Karya Ilmiah, PPKI). The schematic figures, the conceptual
workflow and the Stage~4 architecture diagram, were prepared in
Inkscape.
...
Section~\ref{sec:lit-imerg}. Three latency variants are released:
Early (approximately 4~h), Late (approximately 14~h), and Final
...
gauge first and second moments~\citep{ref:wilks2011}. The relative bias (RB) compares the
sample means:
\begin{equation}
...
the operational range. The thresholds up to 50~mm/day (1, 5, 10,
20, and 50) follow the multi-threshold verification approach of
the World Meteorological Organization (WMO) standard TD-1485
\citep{ref:wmo1485}, while 100 and 150~mm/day extend the range to
...
categorical metrics~\citep{ref:wilks2011, ref:ebert2007} aggregated across all wet days, that is,
...
the Fisher $z$-transform~\citep{ref:wilks2011} standard error
...
processed for the window diagnostic; $178$ of the $180$ archived
stations carry valid half-hourly coverage and enter this diagnostic),
which resolves the dependence of the recovery on the satellite era,
and the GPM era ($2015$ to $2021$),

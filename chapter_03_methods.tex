...
The Gamma family fits the bulk of the wet-day sample by design, so
its upper tail is fit only as a by-product and is systematically too
short for the flood and drought thresholds that matter operationally
(Section~\ref{sec:lit-gpd}). The next stage corrects this.

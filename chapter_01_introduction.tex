...
corrections over Indonesia \citep{ref:suhartanto2025,
ref:ramadhan2024sumatra} and elsewhere \citep{ref:wei2022} adjust
...
bias dimension each stage corrects, and the reach of the correction
along each dimension when judged against independent
...
\begin{enumerate}
    ...
    stage-by-stage against 172 independent Indonesian Meteorological, Climatological, and Geophysical Agency (BMKG) stations,
    ...
    \item To decompose the daily Pearson-correlation ceiling into a
    recoverable calendar-window component and a residual
    retrieval-skill component, by re-aggregating the half-hourly
    satellite source to a window matched to the gauge reporting
    convention, and to characterise the optimal window across
    season, space, and satellite era.

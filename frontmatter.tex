...
headline Pearson $r$ from approximately $0.34$ to approximately
$0.62$ without changing any other pipeline output, and is identified
as the most operationally actionable next step in the discussion. The corrected product
...
konvensi pengamatan tersebut akan mengangkat Pearson $r$ utama
dari sekitar $0{,}34$ ke sekitar $0{,}62$ tanpa mengubah keluaran
\emph{pipeline} lainnya, dan ditetapkan sebagai langkah lanjutan
yang paling dapat dioperasionalkan dalam pembahasan. Produk terkoreksi

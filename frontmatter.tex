...
validasi terhadap $172$ stasiun Badan Meteorologi, Klimatologi, dan
...
sebesar $56\%$ pada ambang $50$~mm/hari ($0{,}097$ dibanding
...
satelit dan stasiun yang berpasangan tetap di sekitar $0{,}34$ pada
keempat tahap, dan berada dalam pita sempit $[0{,}332;~0{,}348]$ untuk
seluruh lima belas konfigurasi \emph{sweep} sensitivitas Bali (bobot
pencampuran, ambang GPD, dan saturasi kerapatan stasiun). Hal ini
sesuai dengan teori koreksi bias berbasis sebaran marginal: karena
koreksi mempertahankan urutan peringkat data, korelasi harian dibatasi
oleh ketepatan waktu \emph{retrieval} satelit mentah, bukan oleh metode
koreksinya. Ketika data IMERG-L setengah-jaman disusun ulang ke dalam
jendela 24 jam yang mengikuti konvensi pengamatan pagi setempat
yang dipakai jaringan validasi BMKG, sebagian besar batas korelasi ini ternyata
berasal dari ketidaksesuaian jendela kalender antara satelit dan
stasiun. Pada era GPM ($2015$ hingga $2021$), korelasi gabungan naik
dari $r = 0{,}20$ pada jendela hari Waktu Universal Terkoordinasi (UTC)
menjadi $r = 0{,}57$ pada jendela $-23$ jam yang selaras, dengan median
per-stasiun $0{,}56$; pergeseran $-23$ jam ini sama untuk seluruh dua
belas musim bergulir tiga-bulanan dan ketiga zona waktu Indonesia,
sedangkan besar korelasi yang dipulihkan bervariasi dari $0{,}56$ di
zona barat (WIB) hingga $0{,}62$ di zona timur (WIT). Pemulihan ini
hanya muncul pada era GPM, ketika \emph{retrieval} sudah mampu menangkap
siklus diurnal; karena itu nilai $0{,}34$ untuk seluruh rekaman
sebenarnya merupakan campuran era ini dengan era awal yang ketepatan
waktunya masih rendah. Ketergantungan terhadap jendela ini lenyap pada
skala bulanan, ketika korelasi mencapai sekitar $0{,}80$ tanpa memandang
pilihan jendela, sehingga batas korelasi harian sesungguhnya terletak
pada pemasangan waktu hari per hari, bukan pada jumlah hujan yang
ditangkap produk. Penyusunan ulang jendela ini hanya satu langkah
praproses di luar \emph{pipeline} koreksi, memerlukan data
setengah-jaman, dan ditetapkan sebagai langkah lanjutan yang paling siap
diterapkan; dengan demikian produk terkoreksi sudah sesuai untuk
aplikasi yang bergantung pada sifat sebaran harian, yaitu ranah yang
tidak terpengaruh oleh penyusunan ulang tersebut.

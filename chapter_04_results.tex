...
%
% Source material:
%   - paper/PPS1691_..._compact_20260526.tex  (compact seminar §3 + §4.1)
%   - paper/PPS1691_..._20260522_seminar.tex  (master seminar, CQI/Taylor figs)
%   - paper/PPS1591_..._mdpi.docx              (parallel MDPI manuscript)
%   - paper/additional_information.md          (§4.2 CQI, §5 detailed analyses)
%
% Figures to reuse:
%   - fig_compact_stage_skill.png (Figure 4.2, headline 4-panel)
%   - fig_compact_paradox.png     (Figure 4.4, paradox 4-panel)
%
% Conventions: no em-dashes; no AI-language; no overclaim;
%              sensitivity caveats preserved; numerical consistency.
% ============================================================
...
\citep{ref:tan2016, ref:ramadhan2022}.
...
classifications \citep{ref:wmo1317}: $1$~mm (measurable), $5$~mm
...
over tropical regions \citep{ref:tang2020, ref:tan2016}.
...
\caption[CQI maps for (left) Linear Scaling, (centre) LSEQM, and (right) LSEQM+DL,]{CQI maps for (left) Linear Scaling, (centre) LSEQM, and (right) LSEQM+DL, computed
...
LSEQM+DL (left panel) and classifying the LSEQM+DL CQI into six
quality tiers (right panel). The LSEQM+DL improvement is

...
%
% Source material:
%   - paper/PPS1691_..._compact_20260526.tex  (compact seminar §4.1, §4.2, §4.3, §4.4)
%   - paper/PPS1591_..._mdpi.docx              (parallel manuscript discussion)
%   - paper/additional_information.md          (§7.4, §7.5, §7.7 limitations)
%
% Conventions: no em-dashes; no AI-language; no overclaim;
%              sensitivity caveats preserved on alpha, GPD threshold,
%              and saturation_count; reproducibility positioned as
%              parallel contribution rather than supplementary feature.
% ============================================================
...
Section~\ref{sec:discussion-subdaily} reports a post-hoc empirical
diagnostic, using the half-hourly IMERG-L source, that quantifies
...
against gauge networks and reanalyses over the tropics
...
time scales \citep{ref:ramadhan2022} reported daily correlations
...
\citep{ref:nashsutcliffe1970}. The bias component is moved cleanly
...
Decree SK.32/TL.202/KB/BMG-2006 \citep{ref:bmkg2006sk32} in
agreement with the World Meteorological Organization guidance in
WMO No.~8 \citep{ref:wmo2018no8}: the rainfall total assigned to
date~$d$ is the 24-hour accumulation ending at the morning
...
mismatch. The pipeline lifts Pearson~$r$ from $0.19$ to $0.34$
by mean and variance rescaling and rank-preserving distributional
correction, exactly the contribution that Section~\ref{sec:discussion-bound}
predicts; the bound discussion correctly assigns the remaining
gap to the timing quality of the retrieval at the observed
window, which the present diagnostic refines into a metadata
component (window mismatch, approximately $0.30$ of the gap)
and a residual retrieval-skill component (approximately the
...
\citep{ref:perkel2018,ref:beg2021}. This is not the central

...
$+0.49$ with a unimodal distribution. The window mismatch is
therefore a metadata convention shared across the entire
network, not a station-specific local effect.

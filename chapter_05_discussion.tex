...
convention rather than the local-midnight timezone offset. The
...
2020, $163$ stations).\label{fig:subdaily-chart}}
\end{figure}
...
lift from $h = 0$ to $h = h^{\star}$.\label{fig:subdaily-map}}
\end{figure}
